...
import com.byted.camp.todolist.NoteActivityChanging;
    ...
    public void bind(final Note note) {
        ...
        itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                Intent intent = new Intent(view.getContext(), NoteActivityChanging.class);
                intent.putExtra("extra", contentText.getText());
